...
export default function Profile() {
  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-10">
      <h1 className="text-3xl font-bold text-stone-900">{t('profile.title')}</h1>
      ...
      <div className="mt-8 rounded-xl border border-stone-200 bg-white p-6">
        ...
        <dl className="mt-6 space-y-4">
          <div className="flex justify-between border-b border-stone-100 pb-3">
            <dt className="font-medium text-stone-700">{t('profile.member_since')}</dt>
          ...
          <div className="flex justify-between border-b border-stone-100 pb-3">
            <dt className="font-medium text-stone-700">{t('profile.role')}</dt>
            <dd className="text-stone-600">{t('profile.roles.user')}</dd>
          </div>
          <div className="flex justify-between border-b border-stone-100 pb-3">
            <dt className="font-medium text-stone-700">{isGerman ? 'E-Mail bestätigt' : 'Email verified'}</dt>
            <dd className="text-stone-600">{user?.emailVerified ? (isGerman ? 'Ja' : 'Yes') : (isGerman ? 'Nein' : 'No')}</dd>
          </div>
          <div className="flex justify-between pb-3">
            <dt className="font-medium text-stone-700">{isGerman ? 'Rechtsversion' : 'Legal version'}</dt>
            <dd className="text-stone-600">{LEGAL_VERSION}</dd>
          </div>
        </dl>
      </div>
