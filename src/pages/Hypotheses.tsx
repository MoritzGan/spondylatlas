...
const STATUS_CONFIG = {
  ...
  challenged: { label: 'Angefochten', color: 'bg-red-100 text-red-700',     icon: '⚔️' },
}
    ...
    >
      ...
      {h.status === 'challenged' && h.criticArgument && (
        <div className="mt-3 rounded-lg bg-red-50 border border-red-100 px-3 py-2 text-xs text-red-700">
          <span className="font-medium">⚔️ Kritik: </span>
    ...
    <div className="mx-auto max-w-4xl px-4 py-10">
      ...
      <div className="mt-3 flex items-center gap-3 text-sm text-gray-500">
        ...
        <span className="rounded-full bg-red-100 px-3 py-1 text-red-700 font-medium">
          ⚔️ {challenged.length} angefochten
        </span>
      </div>
      ...
      {challenged.length > 0 && (
        <section className="mt-10">
          <h2 className="mb-4 text-lg font-semibold text-gray-800">⚔️ Angefochten</h2>
